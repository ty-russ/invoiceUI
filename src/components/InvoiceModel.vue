    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="invoice-work flex flex-column">
        ...
        <div class="work-items">
          ...
          <div @click="addNewInvoiceItem" class="item button">
...
export default {
  ...
  methods: {
    ...mapMutations(["TOGGLE_INVOICE", "TOGGLE_DIALOG", "TOGGLE_EDIT_INVOICE", "UPDATE_INVOICE"]),
    ...
    calcInvoiceTotal() {
      this.invoiceTotal = 0; //reset to zero
      this.invoiceItemList.forEach((item) => {
        this.invoiceTotal += item.total; //increment with each total
      });
    },
    publishInvoice() {
    ...
    async updateInvoice() {
      if (this.invoiceItemList.length <= 0) {
        alert("Kindly,fill the work items!");
      }
      this.loading = true;
...
.invoice-wrap {
  ...
  .invoice-content {
    ...
    color: #fff;
    box-shadow: 10 4px 6px -1px rgba(0, 0, 0, 0.2), 0 2px 4px -1px rgba(0, 0, 0, 0.06);
